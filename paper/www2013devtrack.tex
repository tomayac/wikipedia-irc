...
A~demo of our application is available online at the URL \url{http://wikipedia-irc.herokuapp.com/}.
...
\keywords{Breaking News Detection, Event Detection, Wikipedia, Social Networks}
...
In order for an article cluster to be identified as breaking news candidate,
it has to fulfill the following breaking news criteria.
